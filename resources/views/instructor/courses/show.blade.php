    ...
    <div class="card">
        ...
        <div class="card-content">
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1rem;">
                <div>
                    <label style="display: block; font-size: 0.75rem; color: var(--gray-600); margin-bottom: 0.25rem;">Category</label>
                    <p style="font-weight: 500;">{{ $course->category->name ?? 'N/A' }}</p>
                </div>
                
                <div>
                    <label style="display: block; font-size: 0.75rem; color: var(--gray-600); margin-bottom: 0.25rem;">Price</label>
                    <p style="font-weight: 500;">${{ number_format($course->price, 2) }}</p>
                </div>
                
                <div>
                    <label style="display: block; font-size: 0.75rem; color: var(--gray-600); margin-bottom: 0.25rem;">Status</label>
                    <p>
                        @if($course->is_closed)
                ...
                <div>
                    <label style="display: block; font-size: 0.75rem; color: var(--gray-600); margin-bottom: 0.25rem;">Created</label>
    ...
    <div class="card">
        ...
        <div class="card-content">
            <div style="display: flex; flex-direction: column; gap: 1rem;">
                <div>
                    <label style="display: block; font-size: 0.75rem; color: var(--gray-600); margin-bottom: 0.25rem;">Total Students</label>
                    <p style="font-size: 1.5rem; font-weight: 700; color: var(--blue-600);">{{ $course->enrollments->count() }}</p>
                </div>
                
                <div>
                    <label style="display: block; font-size: 0.75rem; color: var(--gray-600); margin-bottom: 0.25rem;">Average Progress</label>
                    @php
                        $avgProgress = $course->enrollments->avg('progress') ?? 0;
                    @endphp
                    <div style="display: flex; align-items: center; gap: 0.5rem;">
                        <p style="font-size: 1.5rem; font-weight: 700; color: var(--green-600);">{{ round($avgProgress, 1) }}%</p>
                ...
                <div>
                    <label style="display: block; font-size: 0.75rem; color: var(--gray-600); margin-bottom: 0.25rem;">Total Revenue</label>
                ...
                <div>
                    <a href="{{ route('instructor.courses.students', $course->id) }}" class="btn btn-primary" style="width: 100%; margin-top: 1rem;">
    ...
    <div class="card-content">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display: flex; align-items: center; gap: 0.5rem;">
                                    <div style="flex: 1; background: var(--gray-200); height: 6px; border-radius: 3px; overflow: hidden;">
                                        <div style="width: {{ $enrollment->progress }}%; height: 100%; background: var(--green-500);"></div>
                                    </div>
                            ...
                            <td class="text-right">
                                <div class="table-actions">
                                    <button type="button" class="icon-btn" title="Send Message" onclick="alert('Message feature coming soon')">
        ...
        @else
            <div class="empty-state">
                ...
                <p style="color: var(--gray-500); font-size: 0.875rem;">Students will appear here when they enroll in this course</p>
            </div>
        @endif
    </div>
</div>
