                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="table-actions">
                                        <a href="{{ route('instructor.courses.show', $course->id) }}" class="icon-btn"
                                            title="View">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('instructor.courses.edit', $course->id) }}" class="icon-btn"
                                            title="Edit">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="{{ route('instructor.content.index', $course->id) }}" class="icon-btn"
                                            title="Manage Content">
                                            <i class="fas fa-file-alt"></i>
                                        </a>
                                        <form action="{{ route('instructor.courses.delete', $course->id) }}" method="POST"
