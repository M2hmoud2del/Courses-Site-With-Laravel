...
<div class="page-header">
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <div>
            <h2>Add Content</h2>
            <p>Add new content to {{ $course->title }}</p>
        </div>
        <div>
...
<div class="card">
    <div class="card-content">
        <form action="{{ route('instructor.content.store', $course->id) }}" method="POST" style="max-width: 800px; margin: 0 auto;">
            @csrf
            ...
            <div class="form-group">
                ...
                <select id="content_type" name="content_type" class="form-input" required onchange="toggleContentFields()">
                    ...
                    <option value="LESSON" {{ old('content_type') == 'LESSON' ? 'selected' : '' }}>Lesson (Text Content)</option>
                    <option value="VIDEO" {{ old('content_type') == 'VIDEO' ? 'selected' : '' }}>Video (YouTube/Vimeo Link)</option>
                    <option value="DOCUMENT" {{ old('content_type') == 'DOCUMENT' ? 'selected' : '' }}>Document (Google Drive/PDF Link)</option>
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" class="form-input" 
                          rows="3" placeholder="Brief description of this content">{{ old('description') }}</textarea>
            ...
            <div class="form-group" id="content_field">
                ...
                <textarea id="content" name="content" class="form-input" 
                          rows="8" placeholder="Enter your lesson content here">{{ old('content') }}</textarea>
...
<script>
    ...
    function toggleContentFields() {
        ...
        contentField.querySelector('label').innerHTML = 'Content *';
        ...
        if (['VIDEO', 'DOCUMENT', 'LINK'].includes(contentType)) {
            ...
            contentField.style.display = 'block';
            contentField.querySelector('label').innerHTML = 'Lesson Content *';
        }
    }
</script>
@endpush